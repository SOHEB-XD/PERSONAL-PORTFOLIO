            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
                        <div>
                            ...
                            <motion.p variants={up} className="text-base md:text-xl font-light text-gray-400">
                                MERN Stack Developer
                            </motion.p>
                        </div>
                        <motion.div variants={up} className="text-left md:text-right">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-32 md:mb-40">
                    ...
                    >
                        ...
                        <motion.p variants={up} className="text-sm md:text-base font-mono uppercase tracking-[0.1em] text-gray-400 mb-8">
                    ...
                    >
                        <motion.p variants={up} className="text-xs font-mono uppercase tracking-[0.2em] text-gray-500 mb-6">
                            From Symptom to Root Cause
                        </motion.p>
                        <motion.p variants={up} className="text-sm md:text-base font-light leading-relaxed text-gray-300 mb-10">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-20 md:mb-32">
                        <div className="lg:col-span-5">
                            <motion.h4 variants={up} className="text-2xl md:text-4xl font-semibold tracking-tight text-white mb-6">
                                AI Assistant
                            </motion.h4>
                            <motion.p variants={up} className="text-sm md:text-base font-light leading-relaxed text-gray-400">
                        ...
                        <div className="lg:col-span-6 lg:col-start-7">
                            <motion.div variants={up} className="border-b border-white/5 pb-6 mb-6">
                            ...
                            <motion.div variants={up} className="pb-6">
